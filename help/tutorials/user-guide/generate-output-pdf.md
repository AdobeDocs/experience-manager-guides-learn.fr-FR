---
title: Generate PDF
description: Découvrez comment générer une sortie PDF
...
Pour plus d’informations, reportez-vous à la section [Configuration du PDF](#id231KIM004X1).

**Depuis le tableau de bord de la carte**

Pour ouvrir les paramètres prédéfinis de sortie pour PDF, cliquez sur un fichier de mappage DITA dans l’interface utilisateur d’Assets, puis cliquez sur Paramètres prédéfinis de sortie, puis sur l’option du PDF. Dans le tableau de bord de carte, cliquez sur **Modifier** dans la partie supérieure pour mettre à jour les différentes configurations, puis cliquez sur **Enregistrer**.
