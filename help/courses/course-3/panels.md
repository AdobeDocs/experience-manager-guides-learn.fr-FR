---
title: Panneaux
description: Utilisation de panneaux dans les guides d’AEM
...
1. Cliquez sur le bouton [!UICONTROL **Barre latérale**] pour réduire le panneau.
...
1. Cliquez sur le bouton [!UICONTROL **Plus**] icône .

   ![Favoris plus](images/lesson-5/favorites-plus.png)

1. Dans la boîte de dialogue Nouvelle collection, saisissez une **Titre** et un **Description**.
...
1. Cliquez sur le bouton [!UICONTROL **Ellipse**] situé en regard d’une rubrique pour accéder aux options contextuelles.

1. Sélectionner **Ajouter à** > **Favoris**.
...
1. Cliquez avec le bouton droit sur le **Onglet Titre** dans l’éditeur pour accéder aux options contextuelles.

1. Choisir **Ajouter à** > **Favoris**.
...
1. Sous Favoris, cliquez sur le [!UICONTROL **Flèche**] en regard d’une collection pour en afficher le contenu.

   ![Afficher les favoris](images/lesson-5/view-favorites.png)

1. Cliquez sur le bouton [!UICONTROL **Ellipse**] en regard d’une rubrique pour afficher les options contextuelles, y compris la possibilité de la supprimer de la liste Favoris.
...
1. Cliquez sur le bouton [!UICONTROL **Recherche de filtre**] icône .
...
1. Dans la boîte de dialogue Nouveau fragment de code, ajoutez une **Titre** et un **Description**.
...
1. Cliquez sur le bouton [!UICONTROL  **Propriétés du fichier**] dans le panneau de droite.

   ![Icône Propriétés du fichier](images/lesson-5/file-properties-icon.png)

1. Définissez la variable **État du document** to **Modifier**. Notez que la liste Références est actuellement vide.

   ![Aucune référence](images/lesson-5/no-references.png)

1. Fermez la rubrique.

1. Sélectionner [!UICONTROL **Repository View**] dans le panneau de gauche.
...
1. Une fois que la carte est ouverte pour modification, revenez à **Repository View**.

1. Faites glisser et déposez la rubrique que vous utilisez dans la carte.

1. Cliquez sur le bouton [!UICONTROL **Enregistrer**] dans la barre d’outils supérieure.
...
1. Cliquez sur le bouton [!UICONTROL **Réviser**] dans le panneau de droite.
   ...
   ![Icône Réviser](images/lesson-5/review-icon.png)
